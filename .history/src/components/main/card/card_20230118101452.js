...
const mediaCards = [
  ...
  },
  {
    ...
    description: `We provide AI solutions to help you build intelligent workflows, automate processes, advanced analytics, and waste elimination. Our Data discovery experts, and business analysts who help you turn your raw data into actionable insights.`
  }
];
...
export default function Cards() {
  return (
      ...
      <Grid container item xs={10} gap='1rem'  md="10" justifyContent={"center"} alignContent="center" >
