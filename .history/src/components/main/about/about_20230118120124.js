...
const Form = () => {
  ...
  const validate = (values) => {
    ...
    if (!values.yourName) {
      errors.yourName = "Cannot be blank";
    } else if (values.yourName.length < 2) {
      errors.yourName = "your name must be more than 2 characters";
    }
    ...
    } else if (values.yourPhone.length > 20) {
      errors.yourPhone = "phone number must be 10 number";
    }
    if (!values.writeMessage) {
      errors.writeMessage = "Cannot be blank";
    } else if (values.writeMessage.length > 600) {
      errors.writeMessage = "your name must be less than 600 characters";
    }
    return errors;
  };
